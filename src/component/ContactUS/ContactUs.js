      ...
      <div className='row'>
        ...
        <div className='col-md-5 col-sm-8'>
          <div className='contact-info'>
            ...
            <h1>Call. +(91) 8154040074</h1>
            <h4><a href='mailto:shaivpidadi@gmail.com'>shaivpidadi@gmail.com</a></h4>
          </div>
        </div>
        ...
        <div className='col-md-7 col-sm-12'>
          <form id='contact-form'>
            ...
            <div className='col-md-12 col-sm-12'>
              ...
              <textarea className='form-control' rows='5' id='cf-message' name='cf-message' placeholder='Message' />
            </div>
